...
public class IssueChangePostProcessorImpl implements IssueChangePostProcessor {
  ...
  @Override
  public void process(DbSession dbSession, QGChangeEventFactory.IssueChangeData change, Collection<ComponentDto> components) {
    List<QGChangeEvent> gateChangeEvents = liveMeasureComputer.refresh(dbSession, components);
    qualityGateListeners.broadcastOnIssueChange(change, gateChangeEvents);
  }
}
